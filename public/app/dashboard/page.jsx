        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#F8FAFC] rounded-lg shadow-lg p-6 mb-8">
              ...
              <div className="space-y-2">
                {interviews.slice(0, 5).map((interview) => (
                  <div key={interview.id} className="flex justify-between items-center p-3 bg-[#D9EAFD] rounded">
                    <div>
                      <span className="font-medium text-gray-700">Interview #{interview.id}</span>
          ...
          {!session ? (
            <div className="bg-[#F8FAFC] rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Ready to Start Your Interview?</h2>
            ...
            <div className="bg-[#F8FAFC] rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Interview Session</h2>
              <div className="text-center space-y-4">
                <p className="text-gray-700">Session ID: {session.id}</p>
                <p className="text-gray-700">Status: <span className="capitalize font-medium">{session.status}</span></p>
                <p className="text-gray-700">Job ID: {session.job_id}</p>
                {session.bot_url ? (
                  <div className="bg-[#D9EAFD] rounded-lg p-6 mt-6">
                    <p className="font-semibold mb-2 text-gray-700">Pipecat Bot Ready</p>
